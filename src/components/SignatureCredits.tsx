    ...
    return (
        <div className="signature-credits">
            ...
            <div className="signature-links">
                <a href="https://github.com/ImaaValenzuela" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    <Github className="lucide-icon" strokeWidth={1.5} />
                </a>
                <a href="https://www.linkedin.com/in/imanol-valenzuela/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
